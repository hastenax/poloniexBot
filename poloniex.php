<?php
        ...
        class poloniex {
                ...
                public function __construct($api_key, $api_secret, $verbose = false) {
                ...
                public function query(array $req = array()) {
						...
						if ($this->verbose)
							echo $this->t()."Calling query: ".$this->trading_url.' ('.$req['command'].")\n";
                ...
                private function retrieveJSON($URL) {
                        $opts = array('http' =>
                                array(
                                        'method'  => 'GET',
